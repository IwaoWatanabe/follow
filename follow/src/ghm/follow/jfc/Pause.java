...
class Pause extends FollowAppAction {
	...
	public Pause(FollowApp app) {
		...
		super(app, FollowApp.getResourceString("action.Pause.name"), FollowApp
				.getResourceString("action.Pause.mnemonic"), FollowApp
				.getResourceString("action.Pause.accelerator"), FollowApp
				.getIcon(Pause.class, getIconName(false)),
	...
	public void setIconByState(boolean paused) {
		...
		ImageIcon icon = FollowApp.getIcon(Pause.class,
				Pause.getIconName(paused));
