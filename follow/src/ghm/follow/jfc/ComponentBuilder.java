...
class ComponentBuilder {
	...
	public static Menu buildFileMenu(ResourceBundle resources,
			HashMap<String, FollowAppAction> actions) {
		Menu fileMenu = new Menu(resources.getString("menu.File.name"),
		...
		recentFilesMenu = new Menu(
				resources.getString("menu.RecentFiles.name"),
				resources.getString("menu.RecentFiles.mnemonic"),
				FollowApp.getIcon(ComponentBuilder.class,
						"menu.RecentFiles.icon"));
	...
	public static Menu buildEditMenu(ResourceBundle resources,
			HashMap<String, FollowAppAction> actions) {
		Menu editMenu = new Menu(resources.getString("menu.Edit.name"),
				resources.getString("menu.Edit.mnemonic"));
	...
	public static Menu buildToolsMenu(ResourceBundle resources,
			HashMap<String, FollowAppAction> actions) {
		Menu toolsMenu = new Menu(resources.getString("menu.Tools.name"),
				resources.getString("menu.Tools.mnemonic"));
	...
	public static Menu buildWindowMenu(ResourceBundle resources,
			HashMap<String, FollowAppAction> actions) {
		Menu windowMenu = new Menu(resources.getString("menu.Window.name"),
				resources.getString("menu.Window.mnemonic"));
	...
	public static Menu buildHelpMenu(ResourceBundle resources,
			HashMap<String, FollowAppAction> actions) {
		Menu helpMenu = new Menu(resources.getString("menu.Help.name"),
	 ...
	 * @return
	 */
	public static PopupMenu buildPopupMenu(
			HashMap<String, FollowAppAction> actions) {
