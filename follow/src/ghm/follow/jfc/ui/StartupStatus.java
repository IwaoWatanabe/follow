...
public class StartupStatus extends JWindow {
	...
	public StartupStatus(ResourceBundle resourceBundle) {
		LOAD_SYSTEM_FONTS = new Task(2,
				resourceBundle.getString("startupStatus.loadSystemFonts"));
		allTasks.add(LOAD_SYSTEM_FONTS);

		CREATE_WIDGETS = new Task(2,
				resourceBundle.getString("startupStatus.createWidgets"));
		...
		JLabel label = new JLabel(
				resourceBundle.getString("startupStatus.label"));
