...
public class DeleteAll extends FollowAppAction {
	...
	public void actionPerformed(ActionEvent e) {
		if (getApp().getAttributes().confirmDeleteAll()) {
			DisableableConfirm confirm = new DisableableConfirm(
					getApp().getFrame(),
					FollowApp
							.getResourceString("dialog.confirmDeleteAll.title"),
					FollowApp
							.getResourceString("dialog.confirmDeleteAll.message"),
					FollowApp
							.getResourceString("dialog.confirmDeleteAll.confirmButtonText"),
					FollowApp
							.getResourceString("dialog.confirmDeleteAll.doNotConfirmButtonText"),
					FollowApp
							.getResourceString("dialog.confirmDeleteAll.disableText"));
			confirm.pack();
	...
	private void performDelete() {
		...
		List<FileFollowingPane> allFileFollowingPanes = getApp()
		...
		try {
			...
			JOptionPane
					.showMessageDialog(
							getApp().getFrame(),
							FollowApp
									.getResourceString("message.unableToDeleteAll.text"),
							FollowApp
									.getResourceString("message.unableToDeleteAll.title"),
